...
class ZabbixSender():
    ...
    def __init__(self, host='127.0.0.1', port=10051, recv_buffer_size = 4096):
    ...
    def add_noclock(self, host, key, value, clock=None):
        self.data.append({"host":host, "key":key, "value":value})
